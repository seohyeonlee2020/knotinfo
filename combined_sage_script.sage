...
#load extracted data
df = pd.read_csv('results/preliminary_screening.csv')
...
print(f'checked for mod 32, {df.shape[0]} potential ribbon links')
...
df.to_csv('results/script_applied.csv', index=False)
