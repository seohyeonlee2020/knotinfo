...
# This file was *autogenerated* from the file link_table_analysis.sage
from sage.all_cmdline import *   # import sage library

_sage_const_0 = Integer(0); _sage_const_12 = Integer(12); _sage_const_1 = Integer(1); _sage_const_8 = Integer(8); _sage_const_32 = Integer(32)# %%
from snappy import *
import pandas as pd
import re
import numpy as np
...
for link in link_iterator:
	...
	if L.determinant() == _sage_const_0  and _sage_const_12  <= num_crossings:
		#print(linkname)
		linking_matrix = L.linking_matrix()
		matrix_zero = all(x == _sage_const_0  for row in linking_matrix for x in row)
		if matrix_zero:
			...
			link_dct[linkname]['determinant'] = _sage_const_0 
...
link_df = link_df.apply(factor_jones, axis=_sage_const_1 )
...
def check_products(row):
	...
	return mod(det_product, _sage_const_32 ) == mod(jones_det, _sage_const_32 )


shortlist.apply(check_products, axis=_sage_const_1 )


shortlist['mod32_equivalent'] = shortlist.apply(check_products, axis=_sage_const_1 )
...
for linkname, component_id in manual_check_needed:
	try:
		...
		print(iden)
		#Link(link).view()
		sublink_det = Manifold(iden[_sage_const_0 ]).link().determinant()
		mod32 = mod(sublink_det, _sage_const_32 ) == mod(jones_det, _sage_const_32 )
